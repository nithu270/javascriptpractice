...
//we cannot use spl char fro variable name 
...
const myname = "shree";
const backticks = `hellooo, ${myname}!`; 
console.log(backticks);

const add = `{$2+$3}`;
console.log(add); //prints as it as
...
"As this Numbers datatype will care of what type of number is"
 const fnum = 5;
 const snum = 6;
